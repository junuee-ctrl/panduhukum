---
{
  ...
  "changelog": [
    ...
    {
      "date": "2026-07-19",
      "note": "Diverifikasi & diterbitkan (ganti kanal fiktif 'iLapor' ke Dumas Presisi/PolriSiber resmi; pasal KUHP disesuaikan ke KUHP baru; ITE dimutakhirkan ke UU 1/2024; hapus UU 36/1999 tak terverifikasi)"
    }
  ],
  "published": true
}
...
[RINGKASAN]
Penipuan online harus dilaporkan langsung ke Polri melalui aplikasi/website Dumas Presisi (dumaspresisi.polri.go.id) — atau polrisiber.id untuk kejahatan siber — atau ke Polda/Polres setempat dalam waktu secepatnya, disertai bukti lengkap (screenshot, rekaman, transfer bank). Jika penipu menyalahgunakan nama fintech/bank resmi, laporkan sekaligus ke perusahaan resmi tersebut agar mereka segera menutup akun palsu. Hindari membayar "biaya investigasi" kepada siapa pun—itu adalah penipuan berlapis yang juga harus dilaporkan ke polisi.
...
|---|---|---|---|
| **Polri (Dumas Presisi)** | PRESISI Polri Super App atau dumaspresisi.polri.go.id — untuk kejahatan siber: polrisiber.id | Instant (online), verifikasi 1-3 hari | **PERTAMA & UTAMA — segera setelah menyadari penipuan** |
...
**Solusi:** Jangan bayar lagi. Lapor ke Dumas Presisi dan biarkan polisi yang tangani.
...
**Solusi:** Polisi resmi tidak bekerja dengan "broker." Hubungi Polda/Polres langsung atau gunakan Dumas Presisi. Jika ada pihak yang menawarkan diri sebagai perantara dengan minta bayar, itu penipu. Abaikan, catat percakapannya, dan lapor ke Dumas Presisi sebagai penipuan berlapis.
...
**Solusi:** Jika ada penipuan kedua/ketiga (penipu berlapis), lapor JUGA. Satu nomor laporan Dumas Presisi bisa berisikan beberapa modus penipuan dari pelaku yang sama.
...
1. **UU 11/2008 tentang Informasi dan Transaksi Elektronik (ITE)** — sebagaimana diubah dengan UU 19/2016 dan UU 1/2024
   - Pasal 28 ayat (1) jo. Pasal 45A ayat (1) (berita bohong/menyesatkan yang merugikan konsumen dalam transaksi elektronik)
   - Pasal 30 & 32 (akses ilegal / mengubah data secara tidak sah)

2. **KUHP baru (UU No. 1 Tahun 2023, berlaku 2 Januari 2026)**
   - Pasal 492 dst. (penipuan; dahulu Pasal 378 KUHP lama)
   - Pasal 486 (penggelapan; dahulu Pasal 372 KUHP lama)

3. **UU 27/2022 tentang Pelindungan Data Pribadi**
   - Perlindungan data korban dan hak akses informasi

4. **Kanal pelaporan resmi Polri**
   - Dumas Presisi (dumaspresisi.polri.go.id) & PRESISI Polri Super App; PolriSiber.id untuk kejahatan siber

5. **POJK 22/2023 tentang Pelindungan Konsumen dan Masyarakat di Sektor Jasa Keuangan**
   - Perlindungan konsumen terhadap praktik penipuan berkedok jasa keuangan (jika terkait)

---

**Catatan Akhir:** Jangan ragu untuk melaporkan. Setiap laporan Anda membantu polisi membangun pola penipuan dan menangkap pelaku. Selalu prioritaskan laporan ke Polri (Dumas Presisi/Polres) sebagai langkah pertama dan utama.